...
5. **Add Prisma + PostgreSQL** (see prisma-setup.md):
   ...
   - Derive the data model from the prototype's data (`src/data.ts` / `src/types.ts`) + BRD/PRD — the **shapes**, not the rows. The mock rows themselves are thrown away, not seeded.
